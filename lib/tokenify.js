...
const fetch = typeof window === "undefined" ? node_fetch_1.default : window.fetch;
const cookiefetch = fetch_cookie_1.default(fetch);
const tokenify = async (username, password, { log } = {}) => {
    if (log)
