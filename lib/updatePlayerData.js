...
const updatePlayerData = async (token, userID, data, { log } = {}) => {
    if (log)
        console.log("Updating player data...");
    const updateres = await (await node_fetch_1.default(`https://api.prodigygame.com/game-api/v3/characters/${userID}`, {
        headers: {
